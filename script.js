...
let products = [
    {
        "id":3,
        "name":"Билет на живое обучение в офисе HiTE PRO — 30 мая",
        "price":12500.0,
        "image":"https://static.tildacdn.com/stor6639-6335-4539-a130-343937363366/99732103.png",
        "category":"other",
        "description":"Оффлайн-интенсив за 1 день. Идеально подойдёт тем, у кого ещё нет или мало опыта в работе с HiTE PRO.",
        "modifications":[
            {
                "id":"312761",
                "name":"30 мая (суббота)",
    ...
    {
        "id":126,
        "name":"Новый датчик протечки Smart Water",
        "price":2980.0,
        "image":"https://static.tildacdn.com/stor6664-3437-4133-b666-313061303434/2785659961389b156fc13550f8895388.png",
        "category":"datchiki",
        "description":"Новый дизайн, уменьшенные габариты и съемное крепежное кольцо.",
        "modifications":[
            {
                "id":"323790",
                "name":"Белый",
                ...
                "description":"Совместно с датчиком для реализации схемы защиты от протечки воды можно использовать: \n\nблок приема сигнала для электроприводов Relay-Drive с подключением датчика в режим «только закрытие»\nблок приема сигнала Relay-1 с подключением датчика в режим «только включение»\nПри отсутствии протечки датчик отправляет радиосигнал, подтверждающий, что он находится в рабочем состоянии, 1 раз в 2 часа. Если обнаружена протечка воды, датчик начинает отправлять радиосигнал 1 раз в минуту. В комплектацию входит датчик, крепежное кольцо.",
                "instructions":{
                    "pdf":"https://www.hite-pro.ru/wp-content/uploads/2026/04/SmartWater_180x180mm.pdf"
                }
            },
            {
                "id":"323792",
                "name":"Черный",
                "price":2980.0,
                "image":"https://static.tildacdn.com/stor6638-6334-4334-a436-363030663239/13fe344d184659ac38620e943a2a3db5.png",
                "specifications":{
                    "питание":"CR2450",
                    "Кол-во каналов":"1",
                    "Влагозащита":"IP-67"
        ...
        "modifications":[
            {
                ...
                "specifications":{
                    "Кол-во каналов":"4",
                    "MAX резист. нагрузка на 1 канал":"16 A",
                ...
                "instructions":{
                    "pdf":"https://www.hite-pro.ru/wp-content/uploads/manual/DIN-4.RELAY_74x105mm.pdf"
                }
            }
        ]
    },
        ...
        "modifications":[
            {
                ...
                "specifications":{
                    "Кол-во каналов":"4",
                    "MAX нагрузка на уст-во":"25 A",
                    "MAX нагрузка на 1 канал":"16 A",
                    "Питание":"12-48 В DC",
                    "Вес":"150 г",
                    "Габариты":"90 х 36 х 61 мм"
                },
                "description":"Предназначен для управления осветительными приборами\n(включение \\ выключение и регулировка яркости): допускается\nподключение до четырёх одноцветных светодиодных лент или иных\nсветильников. Монтируется на DIN-рейку и оснащено интерфейсом\nдля обмена данными с другими устройствами по шине DATA.",
                "instructions":{
                    "pdf":"https://www.hite-pro.ru/wp-content/uploads/manual/DIN-4.LED_74x105mm.pdf"
                }
            }
        ]
    },
        ...
        "modifications":[
            {
                ...
                "description":"Предназначен для управления RGBW-лентой (включение/\nвыключение, смена цвета и регулировка яркости). Монтируется на\nDIN-рейку и оснащено интерфейсом для обмена данными с другими\nустройствами по шине DATA.",
                "instructions":{
                    "pdf":"https://www.hite-pro.ru/wp-content/uploads/manual/DIN-1.RGBW_74x105mm.pdf"
                }
            }
        ]
    },
    ...
    {
        "id":109,
        "name":"Блок питания ARV-DR15-12 (12V, 1.25A, 15W) (Arlight, IP20 DIN-рейка)",
        "price":2157.0,
        "image":"https://static.tildacdn.com/stor6362-3066-4236-b937-326161653334/ff0fcb489a73d519e1f84941e89a81b1.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 12 В, 1.25 А, 15 Вт. Негерметичный пластиковый корпус IP 20 для установки на DIN-рейку. Габаритные размеры длина 58 мм, ширина 17.5 мм, высота 90 мм. При нагрузке менее 10% после отключения от сети, повторное включение блока питания может быть с задержкой (до 30с).",
        "modifications":[
            {
                "id":"323162",
                "name":"Блок питания ARV-DR15-12 (12V, 1.25A, 15W) (Arlight, IP20 DIN-рейка)",
    ...
    {
        "id":110,
        "name":"Блок питания ARV-DR30-12 (12V, 2A, 24W) (Arlight, IP20 DIN-рейка)",
        "price":3177.0,
        "image":"https://static.tildacdn.com/stor3239-3135-4637-b061-343137346234/14988b139e2e56dd56def3370f9df8fd.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 12 В, 2 А, 24 Вт. Негерметичный пластиковый корпус IP 20 для установки на DIN-рейку. Габаритные размеры длина 58 мм, ширина 35 мм, высота 90 мм.",
        "modifications":[
            {
                "id":"323126",
                "name":"Блок питания ARV-DR30-12 (12V, 2A, 24W) (Arlight, IP20 DIN-рейка)",
    ...
    {
        "id":111,
        "name":"Блок питания ARV-DR60-24 (24V, 2.5A, 60W) (Arlight, IP20 DIN-рейка)",
        "price":4453.0,
        "image":"https://static.tildacdn.com/stor6639-6235-4530-a630-323861623437/fd7d311a7a1c5aeb21bc227cb32f3a96.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 24 В, 2.5 А, 60 Вт. Негерметичный пластиковый корпус IP 20 для установки на DIN-рейку. Габаритные размеры длина 58 мм, ширина 52.5 мм, высота 90 мм. При нагрузке менее 10% после отключения от сети, повторное включение блока питания может быть с задержкой (до 30с).",
        "modifications":[
            {
                "id":"323128",
                "name":"Блок питания ARV-DR60-24 (24V, 2.5A, 60W) (Arlight, IP20 DIN-рейка)",
    ...
    {
        "id":112,
        "name":"Блок питания ARV-DR100-24 (24V, 4.2A, 100W) (Arlight, IP20 DIN-рейка)",
        "price":6611.0,
        "image":"https://static.tildacdn.com/stor3462-6632-4164-b632-303764346637/e6425a004e609efd04e05c8127ad042f.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 24 В, 4.2 А, 100 Вт. Негерметичный пластиковый корпус IP 20 для установки на DIN-рейку. Габаритные размеры длина 58 мм, ширина 70 мм, высота 90 мм. При нагрузке менее 10% после отключения от сети, повторное включение блока питания может быть с задержкой (до 30с).",
        "modifications":[
            {
                "id":"323122",
                "name":"Блок питания ARV-DR100-24 (24V, 4.2A, 100W) (Arlight, IP20 DIN-рейка)",
    ...
    {
        "id":113,
        "name":"Блок питания ARV-DR150-24 (24V, 6.25A, 150W) (Arlight, IP20 DIN-рейка)",
        "price":10792.0,
        "image":"https://static.tildacdn.com/stor3563-3835-4532-a437-343565303565/945c4806d6f4356e68c5034331bbd49e.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 24 В, 6.25 А, 150 Вт. Негерметичный пластиковый корпус IP 20 для установки на DIN-рейку. Габаритные размеры длина 58 мм, ширина 105 мм, высота 90 мм. При нагрузке менее 10% после отключения от сети, повторное включение блока питания может быть с задержкой (до 30с).",
        "modifications":[
            {
                "id":"323124",
                "name":"Блок питания ARV-DR150-24 (24V, 6.25A, 150W) (Arlight, IP20 DIN-рейка)",
    ...
    {
        "id":114,
        "name":"Блок питания ARS-50-12-FA (12V, 4.2A, 50W) (Arlight, IP20 Сетка)",
        "price":2706.0,
        "image":"https://static.tildacdn.com/stor6538-3461-4939-a535-373961393738/7580ff3fa806a8f3847d1fe8e79aed94.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 12 В, 4,2 А, 50 Вт. Негерметичный алюминиевый сетчатый корпус IP 20. Габаритные размеры длина 104 мм, ширина 82 мм, высота 30 мм.",
        "modifications":[
            {
                "id":"323120",
                "name":"Блок питания ARS-50-12-FA (12V, 4.2A, 50W) (Arlight, IP20 Сетка)",
    ...
    {
        "id":115,
        "name":"Блок питания ARS-100-12-FA (12V, 8.5A, 102W) (Arlight, IP20 Сетка)",
        "price":3813.0,
        "image":"https://static.tildacdn.com/stor3832-3932-4434-b635-633331336138/4b7a2a414c77ea9c047f446bdd2235e7.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 12 В, 8,5 А, 102 Вт. Негерметичный алюминиевый сетчатый корпус IP 20. Габаритные размеры длина 134 мм, ширина 97 мм, высота 30 мм.",
        "modifications":[
            {
                "id":"323116",
                "name":"Блок питания ARS-100-12-FA (12V, 8.5A, 102W) (Arlight, IP20 Сетка)",
    ...
    {
        "id":116,
        "name":"Блок питания ARS-150-12-FA (12V, 12.5A, 150W) (Arlight, IP20 Сетка)",
        "price":3995.0,
        "image":"https://static.tildacdn.com/stor3738-6536-4037-b961-666161343631/c0d4ed98d6f5c02fcb21584b2a08fa17.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 200-240 VAC. Выходные параметры: 12 В, 12,5 А, 150 Вт. Негерметичный алюминиевый сетчатый корпус IP 20. Габаритные размеры длина 164 мм, ширина 97 мм, высота 30 мм.",
        "modifications":[
            {
                "id":"323118",
                "name":"Блок питания ARS-150-12-FA (12V, 12.5A, 150W) (Arlight, IP20 Сетка)",
    ...
    {
        "id":117,
        "name":"Блок питания ATS-24-100-LS (24V, 4.1A, 100W) (Arlight, IP20 Сетка)",
        "price":3982.0,
        "image":"https://static.tildacdn.com/stor3563-3763-4465-b133-343964393162/bef034e81a9f0803e9f6763777481caf.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 198-242 VAC. Выходные параметры: 24 В, 4.1 А, 100 Вт. Негерметичный алюминиевый сетчатый корпус IP 20. Возможность регулировки яркости с помощью DIP-переключателей. Функция плавного пуска, время выхода на полную яркость - 5 сек. Габаритные размеры длина 154 мм, ширина 52 мм, высота 27 мм.",
        "modifications":[
            {
                "id":"323130",
                "name":"Блок питания ATS-24-100-LS (24V, 4.1A, 100W) (Arlight, IP20 Сетка)",
    ...
    {
        "id":118,
        "name":"Блок питания ATS-24-150-LS (24V, 6.2A, 150W) (Arlight, IP20 Сетка)",
        "price":4514.0,
        "image":"https://static.tildacdn.com/stor6562-3566-4133-b662-646136383935/087d59dafe60197f523bf3b1e26c22c0.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 198-242 VAC. Выходные параметры: 24 В, 6.2 А, 150 Вт. Негерметичный алюминиевый сетчатый корпус IP 20. Возможность регулировки яркости с помощью DIP-переключателей. Функция плавного пуска, время выхода на полную яркость - 5 сек. Габаритные размеры длина 211 мм, ширина 52 мм, высота 27 мм.",
        "modifications":[
            {
                "id":"323132",
                "name":"Блок питания ATS-24-150-LS (24V, 6.2A, 150W) (Arlight, IP20 Сетка)",
    ...
    {
        "id":119,
        "name":"Блок питания ATS-24-300-LS (24V, 12.5A, 300W) (Arlight, IP20 Сетка)",
        "price":7040.0,
        "image":"https://static.tildacdn.com/stor6465-6535-4037-b663-656530336661/bba931f84e32349531a0be303ac3572e.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 198-242 VAC. Выходные параметры: 24 В, 12.5 А, 300 Вт. Негерметичный алюминиевый сетчатый корпус IP 20. Возможность регулировки яркости с помощью DIP-переключателей. Функция плавного пуска, время выхода на полную яркость - 5 сек. Габаритные размеры длина 221 мм, ширина 62 мм, высота 29 мм.",
        "modifications":[
            {
                "id":"323134",
                "name":"Блок питания ATS-24-300-LS (24V, 12.5A, 300W) (Arlight, IP20 Сетка)",
    ...
    {
        "id":120,
        "name":"Блок питания ATS-LG-24-500-PFC (24V, 20.9A, 500W) (Arlight, IP20 Сетка)",
        "price":23288.0,
        "image":"https://static.tildacdn.com/stor3031-6533-4365-b665-616631363164/30cb561312a642e01a33d220b508cc76.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 24 В, 20.9 А, 500 Вт. Встроенный корректор мощности, PF>0.95. Негерметичный алюминиевый сетчатый корпус IP 20. Наличие контактов состояния выхода DC OK. Регулировка напряжения 22.8-25.2В. Габаритные размеры длина 233 мм, ширина 81 мм, высота 31 мм.",
        "modifications":[
            {
                "id":"323136",
                "name":"Блок питания ATS-LG-24-500-PFC (24V, 20.9A, 500W) (Arlight, IP20 Сетка)",
    ...
    {
        "id":121,
        "name":"Блок питания ATS-LG-24-750-PFC (24V, 31.3A, 750W) (Arlight, IP20 Сетка)",
        "price":31056.0,
        "image":"https://static.tildacdn.com/stor3962-3438-4932-a337-393636356338/4eeb09e8449e9fd71a0b190a2cf2b4c8.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 100-240 VAC. Выходные параметры: 24 В, 31.3 А, 750 Вт. Встроенный корректор мощности, PF>0.95. Негерметичный алюминиевый сетчатый корпус IP 20. Наличие контактов состояния выхода DC OK. Регулировка напряжения 24-28.8В. Габаритные размеры длина 237 мм, ширина 100 мм, высота 41 мм. Не допускается работа с диммерами и контроллерами ШИМ.",
        "modifications":[
            {
                "id":"323138",
                "name":"Блок питания ATS-LG-24-750-PFC (24V, 31.3A, 750W) (Arlight, IP20 Сетка)",
    ...
    {
        "id":122,
        "name":"Блок питания ARPV-24060-A1 (24V, 2.5A, 60W) (Arlight, IP67 Металл)",
        "price":3530.0,
        "image":"https://static.tildacdn.com/stor6430-3531-4164-b965-383430616266/c7ed1cd6d3fbd729bf6e1917c966f44c.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 200-240 VAC. Выходные параметры: 24 В, 2.5 А, 60 Вт. Герметичный алюминиевый корпус IP 67. Рабочая температура -40…+70C⁰. Габаритные размеры длина 137 мм, ширина 38 мм, высота 31 мм.",
        "modifications":[
            {
                "id":"323108",
                "name":"Блок питания ARPV-24060-A1 (24V, 2.5A, 60W) (Arlight, IP67 Металл)",
    ...
    {
        "id":123,
        "name":"Блок питания ARPV-24100-A1 (24V, 4.16A, 100W) (Arlight, IP67 Металл)",
        "price":5689.0,
        "image":"https://static.tildacdn.com/stor6164-3035-4135-b931-393861386365/1870296e59cf917a925044a508de550e.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 200-240 VAC. Выходные параметры: 24 В, 4.16 А, 100 Вт. Герметичный алюминиевый корпус IP 67. Рабочая температура -40…+70C⁰. Габаритные размеры длина 152 мм, ширина 37.5 мм, высота 31 мм.",
        "modifications":[
            {
                "id":"323110",
                "name":"Блок питания ARPV-24100-A1 (24V, 4.16A, 100W) (Arlight, IP67 Металл)",
    ...
    {
        "id":124,
        "name":"Блок питания ARPV-24150-A1 (24V, 6.25A, 150W) (Arlight, IP67 Металл)",
        "price":6906.0,
        "image":"https://static.tildacdn.com/stor3637-6634-4039-b833-646362393637/f6b76df8f4ec49aeac9662b238f01168.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 200-240 VAC. Выходные параметры: 24 В, 6.25 А, 150 Вт. Герметичный алюминиевый корпус IP 67. Рабочая температура -40…+50C⁰. Габаритные размеры длина 174 мм, ширина 56 мм, высота 36 мм.",
        "modifications":[
            {
                "id":"323112",
                "name":"Блок питания ARPV-24150-A1 (24V, 6.25A, 150W) (Arlight, IP67 Металл)",
    ...
    {
        "id":125,
        "name":"Блок питания ARPV-24200-A1 (24V, 8.3A, 200W) (Arlight, IP67 Металл)",
        "price":8437.0,
        "image":"https://static.tildacdn.com/stor3137-6338-4665-b062-323836666639/2fb79de0eaf2d62b5f07da157550acc1.jpg",
        "category":"other",
        "description":"Источник напряжения с гальванической развязкой для светодиодных изделий. Входное напряжение 200-240 VAC. Выходные параметры: 24 В, 8.3 А, 200 Вт. Герметичный алюминиевый корпус IP 67. Рабочая температура -40…+70C⁰. Габаритные размеры длина 174 мм, ширина 56 мм, высота 36 мм.",
        "modifications":[
            {
                "id":"323114",
                "name":"Блок питания ARPV-24200-A1 (24V, 8.3A, 200W) (Arlight, IP67 Металл)",
    ...
    },
    {
        ...
        "price":4509.0,
        "image":"https://static.tildacdn.com/stor3931-6464-4930-b563-656663333265/4ae1da09a1fd07a53f1ed7422d88836c.jpg",
        "category":"other",
        "description":"",
        "modifications":[
            {
                "id":"320700",
                "name":"red - белый корпус, красная индикация",
                "price":4509.0,
                "image":"https://static.tildacdn.com/stor3931-6464-4930-b563-656663333265/4ae1da09a1fd07a53f1ed7422d88836c.jpg",
                "specifications":{},
                "description":"Многофункциональное реле Welrok VIP защищает оборудование от скачков и провалов напряжения, последствий обрыва нулевого провода и превышения тока или полной мощности. Реле отключает нагрузку, если напряжение, ток или мощность выходит за установленные пределы. Нагрузка включается автоматически, когда напряжение вернется в установленный диапазон и истечет время задержки.",
                "instructions":{
                    "pdf":"https://w8k.ru/ivip",
                    "video":"https://welrok.com/support/welrok-vip"
                }
            },
            {
                "id":"320698",
                "name":"black - черный корпус, белая индикация",
                "price":4832.0,
                "image":"https://static.tildacdn.com/stor3438-6337-4339-b734-333331376330/dca33d8d3bd35757d878166b12818207.jpg",
                "specifications":{},
                "description":"Многофункциональное реле Welrok VIP защищает оборудование от скачков и провалов напряжения, последствий обрыва нулевого провода и превышения тока или полной мощности. Реле отключает нагрузку, если напряжение, ток или мощность выходит за установленные пределы. Нагрузка включается автоматически, когда напряжение вернется в установленный диапазон и истечет время задержки.",
                "instructions":{
                    "pdf":"https://w8k.ru/ivip",
            ...
            {
                "id":"320696",
                "name":"white - белый корпус, белая индикация",
                "price":4688.0,
                "image":"https://static.tildacdn.com/stor3738-3432-4162-b036-353636613361/ae88291ac525f08c32f063c343c03eb2.jpg",
                "specifications":{},
                "description":"Многофункциональное реле Welrok VIP защищает оборудование от скачков и провалов напряжения, последствий обрыва нулевого провода и превышения тока или полной мощности. Реле отключает нагрузку, если напряжение, ток или мощность выходит за установленные пределы. Нагрузка включается автоматически, когда напряжение вернется в установленный диапазон и истечет время задержки.",
                "instructions":{
                    "pdf":"https://w8k.ru/ivip",
    ...
    {
        "id":96,
        "name":"Реле напряжения Welrok D2 63A",
        "price":3879.0,
        "image":"https://static.tildacdn.com/stor6466-3264-4431-b662-313135616130/621fe49ad9389d40600c13a53b9e380f.jpg",
        "category":"other",
        "description":"",
        "modifications":[
            {
                ...
                "image":"https://static.tildacdn.com/stor6466-3264-4431-b662-313135616130/621fe49ad9389d40600c13a53b9e380f.jpg",
                "specifications":{},
                "description":"Реле напряжения Welrok D2 защищает оборудование от скачков и провалов напряжения, последствий обрыва нулевого провода. Реле отключает нагрузку, если сетевое напряжение выходит за установленные пределы. Когда значение напряжения вернется в норму, нагрузка будет автоматически включена обратно.",
                "instructions":{
                    "pdf":"https://w8k.ru/id2",
                    "video":"https://welrok.com/support/welrok-d2"
                }
            },
            {
                "id":"320704",
                "name":"black - черный корпус, белая индикация",
                "price":4194.0,
                "image":"https://static.tildacdn.com/stor3139-3032-4933-a465-656330333435/6cc72686e62a8839f653da55c017bee8.jpg",
                "specifications":{},
                "description":"Реле напряжения Welrok D2 защищает оборудование от скачков и провалов напряжения, последствий обрыва нулевого провода. Реле отключает нагрузку, если сетевое напряжение выходит за установленные пределы. Когда значение напряжения вернется в норму, нагрузка будет автоматически включена обратно.",
                "instructions":{
                    "pdf":"https://w8k.ru/id2",
            ...
            },
            {
                ...
                "name":"white - белый корпус, белая индикация",
                "price":4058.0,
                "image":"https://static.tildacdn.com/stor3239-6663-4630-a330-643062303833/3c9333e4e9a2b473b12127a773248283.jpg",
                "specifications":{},
                "description":"Реле напряжения Welrok D2 защищает оборудование от скачков и провалов напряжения, последствий обрыва нулевого провода. Реле отключает нагрузку, если сетевое напряжение выходит за установленные пределы. Когда значение напряжения вернется в норму, нагрузка будет автоматически включена обратно.",
                "instructions":{
                    "pdf":"https://w8k.ru/id2",
    ...
    {
        "id":127,
        "name":"City9 Set Автоматический выключатель (АВ) 1P 4.5kA 230В",
        "price":465.0,
        "image":"https://static.tildacdn.com/stor3438-6162-4834-a433-313132396433/45eb40780ce45881a2fa208658ebdf0b.jpg",
        "category":"other",
        "description":"",
        "modifications":[
            {
                ...
                "image":"https://static.tildacdn.com/stor3438-6162-4834-a433-313132396433/45eb40780ce45881a2fa208658ebdf0b.jpg",
                "specifications":{},
                "description":"Автоматический выключатель серии City9 Set Systeme Electric, 1-полюсный, номинальный ток 6 А, характеристика С, Icn = 4.5 кА. Применяется в электрических сетях напряжением 230 В. Предназначен для защиты от перегрузок и токов короткого замыкания. Оснащен механизмом «мгновенной коммутации». Ударопрочный корпус из специального пластика с 6 металлическими заклепками. Безопасные клеммы исключают попадание кабелей в заклеммное пространство (ранее Schneider Electric Easy9 EZ9F34106).",
                "instructions":{}
            },
            {
                "id":"324590",
                "name":"10А",
                "price":410.0,
                "image":"https://static.tildacdn.com/stor6662-3365-4532-b063-386434613238/91db166d072ea840db1df6e5c460e476.jpg",
                "specifications":{},
                "description":"Автоматический выключатель серии City9 Set Systeme Electric, 1-полюсный, номинальный ток 10 А, характеристика С, Icn = 4.5 кА. Применяется в электрических сетях напряжением 230 В. Предназначен для защиты от перегрузок и токов короткого замыкания. Оснащен механизмом «мгновенной коммутации». Ударопрочный корпус из специального пластика с 6 металлическими заклепками. Безопасные клеммы исключают попадание кабелей в заклеммное пространство (ранее Schneider Electric Easy9 EZ9F34110).",
                "instructions":{}
            },
            {
                "id":"324592",
                "name":"16А",
                "price":381.0,
                "image":"https://static.tildacdn.com/stor6334-3930-4437-a532-626465393335/7a10f8db829899dd1c1bc489e75a8845.jpg",
                "specifications":{},
                "description":"Автоматический выключатель серии City9 Set Systeme Electric, 1-полюсный, номинальный ток 16 А, характеристика С, Icn = 4.5 кА. Применяется в электрических сетях напряжением 230 В. Предназначен для защиты от перегрузок и токов короткого замыкания. Оснащен механизмом «мгновенной коммутации». Ударопрочный корпус из специального пластика с 6 металлическими заклепками. Безопасные клеммы исключают попадание кабелей в заклеммное пространство (ранее Schneider Electric Easy9 EZ9F34116).",
                "instructions":{}
            },
            {
                "id":"324594",
                "name":"20А",
                "price":429.0,
                "image":"https://static.tildacdn.com/stor3838-3838-4331-a632-323237396163/d46e9f48803b285acdcb1281d261b345.jpg",
                "specifications":{},
                "description":"Автоматический выключатель серии City9 Set Systeme Electric, 1-полюсный, номинальный ток 20 А, характеристика С, Icn = 4.5 кА. Применяется в электрических сетях напряжением 230 В. Предназначен для защиты от перегрузок и токов короткого замыкания. Оснащен механизмом «мгновенной коммутации». Ударопрочный корпус из специального пластика с 6 металлическими заклепками. Безопасные клеммы исключают попадание кабелей в заклеммное пространство (ранее Schneider Electric Easy9 EZ9F34120).",
                "instructions":{}
            },
            {
                "id":"324596",
                "name":"25А",
                "price":434.0,
                "image":"https://static.tildacdn.com/stor3261-3635-4338-a664-626531623065/6ff420a0fede51cc8cb34bfe4edd56d9.jpg",
                "specifications":{},
                "description":"Автоматический выключатель серии City9 Set Systeme Electric, 1-полюсный, номинальный ток 25 А, характеристика С, Icn = 4.5 кА. Применяется в электрических сетях напряжением 230 В. Предназначен для защиты от перегрузок и токов короткого замыкания. Оснащен механизмом «мгновенной коммутации». Ударопрочный корпус из специального пластика с 6 металлическими заклепками. Безопасные клеммы исключают попадание кабелей в заклеммное пространство (ранее Schneider Electric Easy9 EZ9F34125).",
                "instructions":{}
            }
        ]
    },
    {
        "id":128,
        "name":"City9 Set Авт. выкл. диф. тока (АВДТ) 1P+N 4.5kA 10мА Тип-A 230В",
        "price":6057.0,
        "image":"https://static.tildacdn.com/stor3737-3664-4633-b433-306335316531/4d6e12581434ccd779af953b81c72a99.jpg",
        "category":"other",
        "description":"",
        "modifications":[
            {
                ...
                "image":"https://static.tildacdn.com/stor3737-3664-4633-b433-306335316531/4d6e12581434ccd779af953b81c72a99.jpg",
                "specifications":{},
                "description":"Автоматические выключатели дифференциального тока (АВДТ) серии City9 Set Systeme Electric,1P+N, номинальный ток 10 А, характеристика С, Icn = 4.5 кА, ток утечки 10 мА, тип А. АВДТ применяется в электрических сетях напряжением 230В. Предназначен для защиты сети от перегрузок, людей от поражения электрическим током и токов короткого замыкания. Уставка по току утечки 10 мА обеспечивает гарантированную защиту людей при прямом прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Безопасные клеммы.",
                "instructions":{}
            },
            {
                "id":"324600",
                "name":"16А",
                "price":5270.0,
                "image":"https://static.tildacdn.com/stor3361-3562-4864-b738-353066366137/286054aad04b956375b97f7a0a6ec5a3.jpg",
                "specifications":{},
                "description":"Автоматические выключатели дифференциального тока (АВДТ) серии City9 Set Systeme Electric,1P+N, номинальный ток 16 А, характеристика С, Icn = 4.5 кА, ток утечки 10 мА, тип А. АВДТ применяется в электрических сетях напряжением 230В. Предназначен для защиты сети от перегрузок, людей от поражения электрическим током и токов короткого замыкания. Уставка по току утечки 10 мА обеспечивает гарантированную защиту людей при прямом прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Безопасные клеммы.",
                "instructions":{}
            },
            {
                "id":"324602",
                "name":"20А",
                "price":5594.0,
                "image":"https://static.tildacdn.com/stor6264-3230-4463-b063-383931353238/1be6762a66a583e4e107ebaff3acfa57.jpg",
                "specifications":{},
                "description":"Автоматические выключатели дифференциального тока (АВДТ) серии City9 Set Systeme Electric,1P+N, номинальный ток 20 А, характеристика С, Icn = 4.5 кА, ток утечки 10 мА, тип А. АВДТ применяется в электрических сетях напряжением 230В. Предназначен для защиты сети от перегрузок, людей от поражения электрическим током и токов короткого замыкания. Уставка по току утечки 10 мА обеспечивает гарантированную защиту людей при прямом прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Безопасные клеммы.",
                "instructions":{}
            }
        ]
    },
    {
        "id":129,
        "name":"City9 Set Авт. выкл. диф. тока (АВДТ) 1P+N 4.5kA 30мА Тип-A 230В",
        "price":5569.0,
        "image":"https://static.tildacdn.com/stor3762-6232-4166-b961-323631643831/ce12742e858636e3bdfae91afdf483dd.jpg",
        "category":"other",
        "description":"",
        "modifications":[
            {
                ...
                "image":"https://static.tildacdn.com/stor3762-6232-4166-b961-323631643831/ce12742e858636e3bdfae91afdf483dd.jpg",
                "specifications":{},
                "description":"Автоматические выключатели дифференциального тока (АВДТ) серии City9 Set Systeme Electric,1P+N, номинальный ток 10 А, характеристика С, Icn = 4.5 кА, ток утечки 30 мА, тип А. АВДТ применяется в электрических сетях напряжением 230В. Предназначен для защиты сети от перегрузок, людей от поражения электрическим током и токов короткого замыкания. Уставка по току утечки 30 мА обеспечивает гарантированную защиту людей при прямом прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Безопасные клеммы.",
                "instructions":{}
            },
            {
                "id":"324606",
                "name":"16А",
                "price":4856.0,
                "image":"https://static.tildacdn.com/stor3461-6232-4233-b166-633536393865/0e26540b6ae5ac2b7a6f2c9315e59c56.jpg",
                "specifications":{},
                "description":"Автоматические выключатели дифференциального тока (АВДТ) серии City9 Set Systeme Electric,1P+N, номинальный ток 16 А, характеристика С, Icn = 4.5 кА, ток утечки 30 мА, тип А. АВДТ применяется в электрических сетях напряжением 230В. Предназначен для защиты сети от перегрузок, людей от поражения электрическим током и токов короткого замыкания. Уставка по току утечки 30 мА обеспечивает гарантированную защиту людей при прямом прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Безопасные клеммы.",
                "instructions":{}
            },
            {
                "id":"324608",
                "name":"20А",
                "price":5148.0,
                "image":"https://static.tildacdn.com/stor6638-3739-4137-b034-653365653634/7a68ef55c98cfdecde41707eb738ed1c.jpg",
                "specifications":{},
                "description":"Автоматические выключатели дифференциального тока (АВДТ) серии City9 Set Systeme Electric,1P+N, номинальный ток 20 А, характеристика С, Icn = 4.5 кА, ток утечки 30 мА, тип А. АВДТ применяется в электрических сетях напряжением 230В. Предназначен для защиты сети от перегрузок, людей от поражения электрическим током и токов короткого замыкания. Уставка по току утечки 30 мА обеспечивает гарантированную защиту людей при прямом прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Безопасные клеммы.",
                "instructions":{}
            }
        ]
    },
    {
        "id":130,
        "name":"City9 Set Выкл. дифф. тока (ВДТ) Тип-A 230В",
        "price":4795.0,
        "image":"https://static.tildacdn.com/stor3532-3235-4733-b062-623837323366/17e4eafd47db3cd38b4b6bbe7e05d79d.jpg",
        "category":"other",
        "description":"",
        "modifications":[
            {
                ...
                "image":"https://static.tildacdn.com/stor3532-3235-4733-b062-623837323366/17e4eafd47db3cd38b4b6bbe7e05d79d.jpg",
                "specifications":{},
                "description":"Выключатель дифференциального тока (ВДТ) или устройство защитного отключения (УЗО) серии City9 Set Systeme Electric, 2-полюсный, номинальный ток 25А, ток утечки 10 мА, тип А, электромеханический. Применяется в электрических сетях напряжением 230В. Уставка по току утечки 10 мА обеспечивает гарантированную защиту людей при прямом и косвенном прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Подключение сверху и снизу. Безопасные клеммы.",
                "instructions":{}
            },
            {
                "id":"324612",
                "name":"63А 2P 30мА",
                "price":6161.0,
                "image":"https://static.tildacdn.com/stor3661-6234-4663-b234-333238303834/04b05fea39132081c259105fddbed612.jpg",
                "specifications":{},
                "description":"Выключатель дифференциального тока (ВДТ) или устройство защитного отключения (УЗО) серии City9 Set Systeme Electric, 2-полюсный, номинальный ток 63А, ток утечки 30 мА, тип А, электромеханический. Применяется в электрических сетях напряжением 230В. Уставка по току утечки 30 мА обеспечивает гарантированную защиту людей при прямом и косвенном прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Подключение сверху и снизу. Безопасные клеммы.",
                "instructions":{}
            },
            {
                "id":"324614",
                "name":"63А 2P 100мА",
                "price":6710.0,
                "image":"https://static.tildacdn.com/stor6564-6332-4636-b530-663838376661/31a4205ee617302dc1d69a63f19a8125.jpg",
                "specifications":{},
                "description":"Выключатель дифференциального тока (ВДТ) или устройство защитного отключения (УЗО) серии City9 Set Systeme Electric, 2-полюсный, номинальный ток 63А, ток утечки 100 мА, тип АС, электромеханический. Применяется в электрических сетях напряжением 230В. Уставка по току утечки 100 мА обеспечивает гарантированную защиту людей при прямом и косвенном прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Подключение сверху и снизу. Безопасные клеммы (ранее Schneider Electric Easy9 EZ9R54263).",
                "instructions":{}
            },
            {
                "id":"324616",
                "name":"63А 2P 300мА",
                "price":6161.0,
                "image":"https://static.tildacdn.com/stor6637-3839-4261-a237-323734373864/d23d2c00673f011864bc5ab619f08feb.jpg",
                "specifications":{},
                "description":"Выключатель дифференциального тока (ВДТ) или устройство защитного отключения (УЗО) серии City9 Set Systeme Electric, 2-полюсный, номинальный ток 63А, ток утечки 300 мА, тип АС, электромеханический. Применяется в электрических сетях напряжением 230В. Уставка по току утечки 300 мА обеспечивает гарантированную защиту людей при прямом и косвенном прикосновении. Кнопка тест обеспечивает проверку работоспособности аппарата. Крепление на DIN-рейку шириной 35 мм. Подключение сверху и снизу. Безопасные клеммы (ранее Schneider Electric Easy9 EZ9R64263).",
                "instructions":{}
            }
        ]
    },
    ...
    {
        "id":86,
        "name":"Розетка Systeme Electric AtlasDesign | без шторок, с/з, 16А, механизм, винтовые клем.",
        "price":202.0,
    ...
    {
        "id":87,
        "name":"Розетка Systeme Electric AtlasDesign | со шторками, с/з, 16А, механизм, винтовые клем.",
        "price":241.0,
